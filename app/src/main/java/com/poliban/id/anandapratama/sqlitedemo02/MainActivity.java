...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemLongClickListener((parent, view, position, id) -> {
            tampilkanMenu(parent, position, id);
            return true;
        });
    }

    private void tampilkanMenu(AdapterView<?> parent, int position, long id) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setItems(items, (dialog, which) -> {
                    ...
                    if (!items[which].equals("Update")) {
                        ...
                        Intent intent = new Intent(this, FriendView.class);                         intent.putExtra("event", EVENT_UPDATE);                         intent.putExtra("id", f.getId());                         startActivity(intent);
